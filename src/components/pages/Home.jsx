...
import { deleteAppointment, getAppointment, getDepartment, uploadAppointment } from '../../services/allAPI';
...
function Home() {
    ...
    const handleuploaddept = async () => {
        ...
        const { fname, lname, age, phone, address, gender, date, time, dept, emailid, pincode } = appointment

        if (!fname || !lname || !age || !phone || !address || !gender || !date || !time || !dept || !emailid || !pincode) {
            ...
            if (response.status >= 200 && response.status < 300) {
                alert(`${response.data.fname} is successfully uploaded`)
    ...
    return (
        <div>
            <div style={{ backgroundImage: "url(https://img.freepik.com/free-photo/senior-woman-with-walking-frame-hospital-waiting-room-rehabilitation-treatment_482257-8586.jpg?w=996&t=st=1699776409~exp=1699777009~hmac=b2840da1dcd4242aa6814fbb844c92ef3471034879c822c9b111af53f01fd71c)", backgroundRepeat: 'no-repeat', backgroundSize: 'cover', height: '580px',overflowY:'hidden' }}>
                <div style={{ height: '600px', overflowY:'hidden'}} className='d-flex  align-items-center '>
                    <Container style={{overflowY:'hidden'}}>
                        <h1 style={{ fontWeight: 'bold', fontSize: '50px', color: 'rgb(60, 12, 57)',overflowY:'hidden' }}>The Health Care You<br></br> can Trust</h1>
                        <Link style={{ textDecoration: 'none' }} to={'/department'}><button style={{ backgroundColor: 'rgb(60, 12, 57)', color: 'white' ,overflowY:'hidden'}} className='btn rounded-4'>Our Doctors  <i class="fa-solid fa-arrow-right"></i></button></Link>
            ...
            <section  >
                <Container>
                    <div>
                        <div className="row d-flex flex-wrap" style={{ height: '620px', overflowY: 'hidden' }}>
                        ...
                        <div className="col-md-6 p-md-5 p-3  " id="appointment" style={{ backgroundColor: 'rgb(60, 12, 57)' }}>
                            ...
                            <form>
                                ...
                                <div className="row"  >
                                    ...
                                    <div className="col-lg-1"></div>
                                    <div className="col-lg-5 " style={{ margin: '5px' }}>
                                        <label style={{ color: "white" }} htmlFor='dept'>Doctor</label>
                            ...
                            <Table striped bordered hover variant="light" style={{ tableLayout: "fixed" }}>
                                <thead>
                                    <tr >
                                        ...
                                        <th style={{ backgroundColor: 'rgb(54, 6, 98)', color: 'white' }}>Doctor</th>
